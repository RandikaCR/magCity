            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_about">
                        <div class="logo-footer logo-white"><img src="{{ asset('assets/common/images/logo-white.png') }}" alt=""></div>
                    ...
                    <div class="widget recent-posts-entry">
                        ...
                        <div class="widget-post-bx">
                            <div class="widget-post clearfix">
                                <div class="dlab-post-media"> <img src="{{ asset('assets/frontend/images/blog/recent-blog/pic1.jpg') }}" alt="" width="200" height="143"> </div>
                            ...
                            <div class="widget-post clearfix">
                                <div class="dlab-post-media"> <img src="{{ asset('assets/frontend/images/blog/recent-blog/pic2.jpg') }}" alt="" width="200" height="160"> </div>
                                <div class="dlab-post-info">
                                    <div class="dlab-post-header">
                            ...
                            <div class="widget-post clearfix">
                                <div class="dlab-post-media"> <img src="{{ asset('assets/frontend/images/blog/recent-blog/pic3.jpg') }}" alt="" width="200" height="160"> </div>
                                <div class="dlab-post-info">
                                    <div class="dlab-post-header">
