<div class="section-full bg-white py-4" id="counters-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-3 col-6 mb-3 mb-sm-0 counter-item-1">
                <div class="row">
                    <div class="col-3 col-sm-2 counter-item-image-area">
                        <img class="img-fluid" src="{{ asset('assets/common/images/icon-1.png') }}" alt="">
                    </div>
                    <div class="col-9 col-sm-10">
                        <p class="mb-0 fw-bold counter-item-text-top"><span class="count" data-count="20000" data-timer="2500">0</span>+</p>
                        <p class="mb-0 counter-item-text-bottom">Warranty Registered Vehicles</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 col-6 mb-3 mb-sm-0 counter-item-2">
                <div class="row">
                    <div class="col-3 col-sm-2 counter-item-image-area">
                        <img class="img-fluid" src="{{ asset('assets/common/images/icon-2.png') }}" alt="">
                    </div>
                    <div class="col-9 col-sm-10">
                        <p class="mb-0 fw-bold counter-item-text-top"><span class="count" data-count="8" data-timer="2000">0</span>+ LOCATIONS</p>
                        <p class="mb-0 counter-item-text-bottom">Across Sri Lanka</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 col-6 mb-3 mb-sm-0 counter-item-3">
                <div class="row">
                    <div class="col-3 col-sm-2 counter-item-image-area">
            ...
            <div class="col-sm-3 col-6 mb-3 mb-sm-0 counter-item-4">
                <div class="row">
                    <div class="col-3 col-sm-2 counter-item-image-area">
                        <img class="img-fluid" src="{{ asset('assets/common/images/icon-4.png') }}" alt="">
                    </div>
                    <div class="col-9 col-sm-10">
                        <p class="mb-0 fw-bold counter-item-text-top"><span class="count" data-count="5" data-timer="2000">0</span> YEAR</p>
