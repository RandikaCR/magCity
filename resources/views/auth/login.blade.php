...
@endsection
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Magcity Admin Panel</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Magcity Admin Panel.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    @if($errors->any())
                                        <div class="row">
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                ...
                                                <a class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none pw-visibility" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-info w-100 app-login" type="submit">Sign In</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function (){
            $('.pw-visibility').on('click', function ($e){
